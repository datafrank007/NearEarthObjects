...
class NearEarthObject:
    ...
    def __str__(self):
        ...
        return (f"A Near Earth Object having the following properties: (designation={self.designation!r}, name={self.name!r}, "
...
class CloseApproach:
    ...
    def __init__(self, info):
        ...
        self.info = info
        self._designation = str(self.info['des'])
        self.time = cd_to_datetime(self.info['cd'])  # TODO: Use the cd_to_datetime function for this attribute.
